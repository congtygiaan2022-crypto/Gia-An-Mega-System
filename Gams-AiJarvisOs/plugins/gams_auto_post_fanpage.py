...
logger = get_module_logger("gams_auto_post_fanpage")

class Plugin:
    def __init__(self):
        self.name = "gams_auto_post_fanpage"
        self.description = "Tự động đăng bài viết, hình ảnh, video lên Fanpage Facebook hàng loạt."

    def run(self, **kwargs):
        cwd = r"E:\Gams-AutoPostFanpage"
