...
logger = get_module_logger("gams_fb_copyright_checker")

class Plugin:
    def __init__(self):
        self.name = "gams_fb_copyright_checker"
        self.description = "Quét bản quyền và quản lý kháng nghị video trên Facebook."

    def run(self, **kwargs):
        cwd = r"E:\Gams-FbCopyrightChecker"
